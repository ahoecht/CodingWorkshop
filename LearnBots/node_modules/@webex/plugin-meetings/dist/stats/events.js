...
var StatsEvents = function () {
  ...
  (0, _createClass3.default)(StatsEvents, [{
    ...
    value: function stop() {
      ...
      var sendAnalysis = _analyzer2.default.analyze(fiveSecondsData, { analysisKeys: [{ key: _constants.EVENT_STATS_MAP.BYTES_SENT, check: _constants.ANALYSIS_CHECKS.INCREASING }] });
      var receiveAnalysis = _analyzer2.default.analyze(fiveSecondsData, { analysisKeys: [{ key: _constants.EVENT_STATS_MAP.BYTES_RECEIVED, check: _constants.ANALYSIS_CHECKS.INCREASING }] });
