  ...
  */
  ...
  (0, _createClass3.default)(Meeting, [{
    ...
    value: function sendCallAnalyzerMetrics(options) {
      ...
      var payload = _metrics2.default.initPayload(options.event, identifiers, options);
    ...
    value: function setRemoteStream(pc) {
      ...
      pc.ontrack = function (event) {
        ...
        _this13.mediaProperties.remoteStream = streams;
        ...
        _triggerProxy2.default.trigger(_this13, {
          ...
          stream: _util4.default.createMediaStream([_this13.mediaProperties.remoteStream.getAudioTracks()[0]])
        });
        ...
        _triggerProxy2.default.trigger(_this13, {
          ...
          stream: _util4.default.createMediaStream([_this13.mediaProperties.remoteStream.getVideoTracks()[0]])
        });

        if (_this13.mediaProperties.remoteStream.getVideoTracks()[1]) {
          _triggerProxy2.default.trigger(_this13, {
            file: 'meeting/index',
            function: 'setRemoteStream:pc.ontrack'
          }, _constants.EVENT_TRIGGERS.MEDIA_READY, {
            type: _constants.EVENT_TYPES.REMOTE_SHARE,
            stream: _util4.default.createMediaStream([_this13.mediaProperties.remoteStream.getVideoTracks()[1]])
          });
        }
      };
    }
    ...
    value: function closeRemoteStream() {
      ...
      return _media2.default.stopStream(this.mediaProperties.remoteStream).then(function () {
        _triggerProxy2.default.trigger(_this14, {
          file: 'meeting/index',
    ...
    value: function setShareStream(pc) {
      ...
      pc.ontrack = function (event) {
        ...
        _this15.mediaProperties.remoteShare = _event$streams[0];
    ...
    value: function closeLocalStream() {
      ...
      return _media2.default.stopTracks(this.mediaProperties.audioTrack).then(function () {
        return _media2.default.stopTracks(_this17.mediaProperties.videoTrack);
      }).then(function () {
    ...
    value: function joinWithMedia() {
      ...
      this.join(joinOptions).then(function (joinResponse) {
        return _this24.getMediaStreams(mediaSettings, audioVideoOptions).then(function (_ref) {
          var _ref2 = (0, _slicedToArray3.default)(_ref, 2),
              localStream = _ref2[0],
              localShare = _ref2[1];

          return _this24.addMedia({
    ...
    value: function reconnect() {
      ...
      return this.reconnectionManager.reconnect(this).then(function (reconnect) {
        _triggerProxy2.default.trigger(_this25, {
          file: 'meeting/index',
          function: 'reconnect'
    ...
    value: function join() {
      ...
      return _util2.default.joinMeetingOptions(this, options).then(function (join) {
        _this26.meetingFiniteStateMachine.join();

        return _promise2.default.resolve(join);
      }).catch(function (error) {
        _this26.meetingFiniteStateMachine.fail(error);
    ...
    value: function moveTo(resourceId) {
      ...
      return _util2.default.joinMeetingOptions(this, { resourceId: resourceId, moveToResource: true }).then(function () {
        _this27.meetingFiniteStateMachine.join();

        return _this27.updateMedia({
          mediaSettings: {
            sendVideo: false, receiveVideo: false, sendAudio: false, receiveAudio: false, sendShare: false, receiveShare: false
          }
        }).then(function () {
          return _promise2.default.resolve(_this27);
        });
      }).catch(function (error) {
        _this27.meetingFiniteStateMachine.fail(error);
    ...
    value: function moveFrom(resourceId) {
      ...
      return _util2.default.joinMeetingOptions(this).then(function (join) {
        return _this28.getMediaStreams({ sendAudio: true, sendVideo: true, sendShare: false }).then(function (_ref3) {
          var _ref4 = (0, _slicedToArray3.default)(_ref3, 2),
              localStream = _ref4[0],
              localShare = _ref4[1];

          return _this28.updateMedia({
            mediaSettings: {
          ...
          return _util2.default.leaveMeeting(_this28, { resourceId: resourceId, correlationId: oldCorrelationId, moveMeeting: true });
        });
      }).then(function () {
        _this28.webex.meetings.meetingCollection.delete(oldCorrelationId);
    ...
    value: function addMedia() {
      ...
      return _util2.default.validateOptions(options).then(function () {
        _util2.default.setPeerConnectionEvents(_this29);

        return _this29.preMedia(localStream, localShare, mediaSettings);
      }).then(function () {
        return _media2.default.attachMedia(_this29.mediaProperties, _this29.id).then(function (peerConnection) {
          _loggerProxy2.default.logger.log('Meeting:index->addMedia#PeerConnection Received from attachMedia ' + peerConnection);
          _this29.setRemoteStream(peerConnection);
          _util2.default.startInternalStats(_this29);
        }).catch(function (err) {
          _this29.logger.error('Meeting:index#join --> Error joining the call on roap initialization, ', err);
          throw err;
        }).then(function () {
          return new _promise2.default(function (resolve, reject) {
            ...
            if (_this29.type === _constants._CALL_) {
              resolve();
            }
            var joiningTimer = setInterval(function () {
              timerCount += 1;
              if (_this29.meetingState === _constants.FULL_STATE.ACTIVE) {
          ...
          return _this29.roap.sendRoapMediaRequest({
            sdp: _this29.mediaProperties.peerConnection.sdp,
            roapSeq: _this29.roapSeq,
            meeting: _this29 // or can pass meeting ID
          }).catch(function (err) {
            _this29.logger.error('Meeting:index#join --> Error joining the call on send roap media request, ', err);
            throw err;
          });
        }).then(function () {
          if (mediaSettings && mediaSettings.sendShare && localShare) {
            if (_this29.state === _constants.MEETING_STATE.STATES.JOINED) {
              return _this29.share();
            }

            // When the self state changes to JOINED then request the floor
            _this29.floorGrantPending = true;
          }
    ...
    value: function updateMedia() {
      ...
      return _util2.default.validateOptions(options).then(function () {
        return _this30.preMedia(localStream, localShare, mediaSettings);
      }).then(function () {
        return _media2.default.updateMedia(_this30.mediaProperties, _this30.id).then(function (peerConnection) {
          _loggerProxy2.default.logger.log('Meeting:index->updateMedia#PeerConnection received from updateMedia, ' + peerConnection);
          _this30.setRemoteStream(peerConnection);
          ...
          return _this30.roap.sendRoapMediaRequest({
            sdp: _this30.mediaProperties.peerConnection.sdp,
            roapSeq: _this30.roapSeq,
            meeting: _this30 // or can pass meeting ID
          }).catch(function (err) {
            _loggerProxy2.default.logger.error('Meeting:index#updateMedia --> Error updateMedia on send roap media request, ', err);
            throw err;
          });
        }).then(function () {
          return _this30.checkForStopShare(mediaSettings.sendShare, previousSendShareStatus);
        }).then(function (startShare) {
          // This is a special case if we do an /floor grant followed by /media
          // we actually get a OFFER from the server and a GLAR condition happens
          if (startShare) {
            // We are assuming that the clients are connected when doing an update
            return _this30.share();
          }
    ...
    value: function updateAudio(options) {
      ...
      return _util2.default.validateOptions({ sendAudio: sendAudio, localStream: stream }).then(function () {
        return _util2.default.updateTransceiver({
          ...
          peerConnection: _this31.mediaProperties.peerConnection,
          previousMediaDirection: {
            sendTrack: _this31.mediaProperties.mediaDirection.sendAudio,
            receiveTrack: _this31.mediaProperties.mediaDirection.receiveAudio
          }
        }, {
          mediaProperties: _this31.mediaProperties,
          roapSeq: _this31.roapSeq,
          meeting: _this31,
          id: _this31.id
        });
      }).then(function () {
        _this31.setLocalTracks(stream);
        _this31.mediaProperties.mediaDirection.sendAudio = sendAudio;
        _this31.mediaProperties.mediaDirection.receiveAudio = receiveAudio;
      });
    }
    ...
    value: function updateVideo(options) {
      ...
      return _util2.default.validateOptions({ sendVideo: sendVideo, localStream: stream }).then(function () {
        return _util2.default.updateTransceiver({
          ...
          peerConnection: _this32.mediaProperties.peerConnection,
          previousMediaDirection: {
            sendTrack: _this32.mediaProperties.mediaDirection.sendVideo,
            receiveTrack: _this32.mediaProperties.mediaDirection.receiveVideo
          }
        }, {
          mediaProperties: _this32.mediaProperties,
          roapSeq: _this32.roapSeq,
          meeting: _this32,
          id: _this32.id
        });
      }).then(function () {
        _this32.setLocalTracks(stream);
        _this32.mediaProperties.mediaDirection.sendVideo = sendVideo;
        _this32.mediaProperties.mediaDirection.receiveVideo = receiveVideo;
      });
    }
    ...
    value: function updateShare(options) {
      ...
      return _util2.default.validateOptions({ sendShare: sendShare, localShare: stream }).then(function () {
        return _this33.checkForStopShare(sendShare, previousSendShareStatus);
      }).then(function (startShare) {
        return _util2.default.updateTransceiver({
          type: 'video',
          sendTrack: sendShare,
          ...
          previousMediaDirection: {
            sendTrack: _this33.mediaProperties.mediaDirection.sendShare,
            receiveTrack: _this33.mediaProperties.mediaDirection.receiveShare
          }
        }, {
        ...
        _this33.setLocalShareTrack(stream);
        _this33.mediaProperties.mediaDirection.sendShare = sendShare;
        _this33.mediaProperties.mediaDirection.receiveShare = receiveShare;
      });
    }
    ...
    value: function acknowledge(type) {
      ...
      if (type === _constants._INCOMING_) {
        return this.meetingRequest.acknowledgeMeeting({
          ...
          _this34.meetingFiniteStateMachine.ring(type);
          _metrics2.default.postEvent({ event: _config.eventType.ALERT_DISPLAYED, meeting: _this34 });
    ...
    value: function decline() {
      ...
      return _util2.default.declineMeeting(this, reason).then(function (decline) {
        _this35.meetingFiniteStateMachine.decline();
    ...
    value: function leave() {
      ...
      return _util2.default.leaveMeeting(this, options).then(function (leave) {
        _this36.meetingFiniteStateMachine.leave();
        // TODO: more testing before we remove this code, we are not sure the scenarios for destroy here
        if (_this36.wirelessShare || _this36.guest) {
          // If screen sharing clean the meeting object
          _triggerProxy2.default.trigger(_this36, {
            file: 'meeting/index',
            function: 'leave'
          }, _constants.EVENTS.DESTROY_MEETING, {
    ...
    value: function share() {
      ...
      if (content && !this.isSharing) {
        ...
        return this.meetingRequest.changeMeetingFloor({
          ...
          _this37.isSharing = true;
          _triggerProxy2.default.trigger(_this37, {
            file: 'meeting/index',
            function: 'share'
          }, _constants.EVENT_TRIGGERS.MEETING_STARTED_SHARING_LOCAL);
          _metrics2.default.postEvent({ event: _config.eventType.LOCAL_SHARE_FLOOR_GRANTED, meeting: _this37 });
