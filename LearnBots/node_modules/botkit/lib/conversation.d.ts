...
export declare class BotkitConversation<O extends object = {}> extends Dialog<O> {
     ...
     */
    ask(message: Partial<BotkitMessageTemplate> | string, handlers: BotkitConvoHandler | BotkitConvoTrigger[], key: {
        key: string;
     ...
     * @param thread_name Name of thread to which message will be added
     */
    addQuestion(message: Partial<BotkitMessageTemplate> | string, handlers: BotkitConvoHandler | BotkitConvoTrigger[], key: {
        key: string;
